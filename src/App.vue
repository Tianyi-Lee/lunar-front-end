...
<script lang="ts" setup>
	...
	window.onbeforeunload = () => {
		sessionStorage.setItem("userInfo", JSON.stringify(JSON.stringify(useUserInfoStore().getUserInfo)));
	};
	...
	window.addEventListener("storage", (e: any) => {
		if (e.key === "token" || e.key === "userId") sessionStorage.setItem(e.key, e.oldValue);
	});
</script>
